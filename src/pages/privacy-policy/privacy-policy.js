      ...
      <Content>
        <Format>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Commandability.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Commandability, accessible
                from{" "}
                <a href="https://commandability.app">
                  https://commandability.app
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              By email:{" "}
              <a href="mailto:support@commandability.app">
                support@commandability.app
              </a>
            </li>
          </ul>
        </Format>
